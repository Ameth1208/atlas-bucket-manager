  ...
  render() {
    return html`
      <div class="fixed bottom-4 left-4 z-30 group">
        <!-- Badge -->
        <div class="flex items-center gap-2 px-3 py-1.5 bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm rounded-full border border-slate-200 dark:border-dark-700 shadow-sm hover:shadow-md transition-all duration-200 cursor-help">
        ...
        <div class="absolute bottom-full left-0 mb-2 px-3 py-2 bg-dark-900 text-white text-xs rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
