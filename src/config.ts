...
console.log(`[Config] Environment check: PORT=${process.env.PORT}, MINIO_ENDPOINT=${process.env.MINIO_ENDPOINT}, AWS_ACCESS_KEY_ID=${process.env.AWS_ACCESS_KEY_ID ? 'Set' : 'Not Set'}`);
